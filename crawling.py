...
def crawling_process(srh_krd):
    ...
    # pg.alert(f"<{srh_krd}> 키워드로 검색한 결과 중 최근 게시글을 크롤링 완료하였습니다!")
...
# 엑셀에 데이터 저장
def data_to_excel(crawling_date, srh_krd):
    # 시간 열 나누기 (1개 -> 2개)
    global time_data
